  ...
  void initState() {
        ...
        Container(
          ...
          child: TextButton(
            ...
            child: Text(
              'Start',
              style: TextStyle(
                  fontSize: 27, color: Color(AppColors.secondaryBackground)),
            ),
    ...
    pages = [
      PageData(
          ...
          bgColor: Color(AppColors.primaryBackground),
          title:
              "\nquickpaisa is a prototype of a fund-transfer platform.\nHence, it cannot be used for making real payments or receiving real money as of now\nquickpaisa was created from designs found on Dribbble, Behance & Pinterest\n\n\n\n\n\n\t(Swipe right or tap the circle below)"),
      PageData(
