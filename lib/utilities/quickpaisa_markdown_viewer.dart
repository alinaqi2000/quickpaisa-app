...
import 'package:quickpaisa/utilities/url_external_launcher.dart';

class quickpaisaMarkdownViewer extends StatefulWidget {
  final String screenName;
  final String urlRequested;
  const quickpaisaMarkdownViewer(
      {Key? key, required this.screenName, required this.urlRequested});
  @override
  quickpaisaMarkdownViewerState createState() =>
      quickpaisaMarkdownViewerState();
}

class quickpaisaMarkdownViewerState extends State<quickpaisaMarkdownViewer> {
  @override
  void initState() {
    super.initState();
  }
