...
import 'package:quickpaisa/components/settings_screen/license_data.dart';
    ...
    return Scaffold(
        ...
        body: Column(children: [
          Wrap(
            ...
            spacing: 6.18,
            children: [
              Image.asset('assets/images/quickpaisa_system/quickpaisa-logo.png',
                  height: 48, width: 48),
              Image.asset('assets/images/quickpaisa_system/quickpaisa-name.png',
                  height: 48),
